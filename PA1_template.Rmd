...
```
Total number of missing values is **`r NAs`**

2. Devise a strategy for filling in all of the missing values in the dataset.

- **Use the mean for 5-minute interval to impute missing data**
...
```{r ihist, echo=TRUE, results='hide'}
...
hist(ip_day[is.na(rd_day[2])==FALSE,2], breaks="fd",xlim=c(xmin, xmax), 
...
**There is no significant difference of mean and median between before imputing and after inputing. As well, the shapa of Histogram is very alike. There is no impact of imputing of using the mean for 5-minute interval.**
...
```{r weektimedata, echo=TRUE, results='hide'}
...
xt <- "time of day"
yt <- "number of steps"
mt <- paste(v_week, "- Average number of steps of \neach 5-minutes interval")
plot(dt_time_week[dt_time_week[,1]==v_week,2], dt_time_week[dt_time_week[,1]==v_week,3], type='l',main = mt, ylim=c(0,250), cex.main=1, col="dark red", xlab= xt, ylab=yt)
